...
public class OnHDDResultAccumulatorTest {
    @Test
    public void test1() throws Exception {
        ...
        OutputPort<CDR3ExtractionResult> results = (OutputPort) CUtils.wrap(reader, extractor);
        ...
        OnHDDResultAccumulator acc = new OnHDDResultAccumulator();
        ...
        while ((result = results.take()) != null) {
            ...
            result = result.substituteSource(source);
        ...
        HashSet<Clone> clones1 = new HashSet<>(clones);
        ...
        for (Clone c : generator.getCloneSet().getClones())
            assertTrue(clones1.remove(c));

        assertTrue(clones1.isEmpty());
