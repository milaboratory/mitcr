...
public interface AnalysisListener {
    VJMapperListener getVListener();

    VJMapperListener getJListener();

    CDR3ExtractorListener getCDR3ExtractorListener();

    CloneGeneratorListener getCloneGeneratorListener();

    ClusterizationListener getClusterizationListener();

    void analysisStarted(Parameters parameters, SegmentLibrary library, int threads);

    void cdr3ExtractionFinished();

    void beforeClusterization(CloneSet cloneSet);
