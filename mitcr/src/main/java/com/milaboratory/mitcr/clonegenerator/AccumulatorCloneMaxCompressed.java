...
public final class AccumulatorCloneMaxCompressed extends AccumulatorCloneMax {
    public static final AccumulatorCloneFactory FACTORY = new AccumulatorCloneFactory() {
        ...
        public AccumulatorClone create(int id, NucleotideSQPair cdr3, boolean saveLinks) {
            return new AccumulatorCloneMaxCompressed(id, cdr3, saveLinks);
        }
    };

    private byte[][] barcodeAccumulators = new byte[3][];

    AccumulatorCloneMaxCompressed(int id, NucleotideSQPair cdr3, boolean saveLinks) {
