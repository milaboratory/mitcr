...
/**
 * A CDR3 extractor for a {@link SSequencingRead}
 *
 * @author Bolotin Dmitriy (bolotin.dmitriy@gmail.com)
 * @author Shugay Mikhail (mikhail.shugay@gmail.com)
 */
public final class CDR3ExtractorFromSRead extends CDR3Extractor<SSequencingRead> {
    /**
     * Creates a CDR3 extractor for a {@link SSequencingRead}
     *
     ...
     */
    public CDR3ExtractorFromSRead(Species species, Gene gene, CDR3ExtractorParameters parameters,
                                  SegmentLibrary segmentLibrary, QualityInterpretationStrategy qStrategy) {
        this(species, gene, parameters, segmentLibrary, qStrategy,
                null);
    }
    ...
    @Override
    public CDR3ExtractionResult<SSequencingRead> process(SSequencingRead input) {
        return _process(input.getData(), input);
    }
}
