...
/**
 * A factory to be used in {@link cc.redberry.pipe.blocks.ParallelProcessor}. See {@link CDR3ExtractorFromSRead} for
 * details
 *
 * @author Bolotin Dmitriy (bolotin.dmitriy@gmail.com)
 * @author Shugay Mikhail (mikhail.shugay@gmail.com)
 */
public final class CDR3ExtractorFactoryFromSRead extends CDR3ExtractorFactory<SSequencingRead> {
    /**
     * Creates a CDR3 extractor factory for a {@link SSequencingRead}
     *
     ...
     */
    public CDR3ExtractorFactoryFromSRead(Species species, Gene gene, CDR3ExtractorParameters parameters,
    ...
    @Override
    public Processor<SSequencingRead, CDR3ExtractionResult<SSequencingRead>> create() {
        return new CDR3ExtractorFromSRead(species, gene, parameters, segmentLibrary, qStrategy, listener);
    }
